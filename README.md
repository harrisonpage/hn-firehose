...
The app collects nothing. Full policy: [harrison.page/hn-firehose/privacy.html](https://harrison.page/hn-firehose/privacy.html)
...
./build.sh release      # App Store .ipa in build/export (needs DEVELOPMENT_TEAM)
```
...
* App icon sizes generated with [App Icon Generators](https://www.appicongenerators.com)
